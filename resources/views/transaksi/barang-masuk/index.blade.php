    ...
    <div class="card-surface">
        <div class="card-surface-header">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="section-title mb-0">Daftar Barang Masuk</h3>
            ...
            <div class="table-responsive">
                <table class="table table-custom align-middle mb-0 mt-4">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-3">
                                        ...
                                        @if ($transaksi->status_transaksi == 'selesai')
                                            <form action="{{ route('transaksi.barang-masuk.cancel', $transaksi) }}"
                                                method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center py-4">Belum ada transaksi barang masuk.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
