    ...
    <section class="card-surface">
        ...
        <div class="card-surface-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('spareparts.create') }}" class="btn btn-brand d-flex align-items-center gap-2 px-4">
            ...
            <form method="GET" action="{{ route('spareparts.index') }}">
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-md-4">
                        <select class="form-select form-select-table-pill user-search-input" name="status" onchange="this.form.submit()">
                            <option value="">
                                Semua Sparepart
                            </option>
